...
module.exports = async function (context, req) {
    ...
    var download = ""; 
    var downloadpng = "https://" + storageName + ".blob.core.windows.net/images/" + username + ".png";
    var downloadjpg = "https://" + storageName + ".blob.core.windows.net/images/" + username + ".jpeg"; 
